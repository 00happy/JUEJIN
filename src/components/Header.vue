<template>
  <div class="headerWrap" >
    ...
    <el-popover
      placement="bottom"
      :popper-class="isFocus ? 'bigPopover' : 'searchPopover'"
      trigger="focus"
      :visible-arrow="false"
    >
      <div class="historyWrap">
        <div class="head" >
          <div>搜索历史</div>
          <div style="color: #007fff; cursor: pointer" @click="clearHistory">
            清空
          </div>
        </div>
        <ul>
    ...
    <div class="writerCenter" :class="isFocus ? 'disapear' : ''">
      ...
      >
        ...
        <el-button class="btnMore" @click.capture="toggle" slot="reference"
          ><i
            class="el-icon-caret-bottom"
            :class="writerFlag ? 'isWrite' : ''"
          ></i
        ></el-button>
      </el-popover>
    </div>
