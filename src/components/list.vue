  ...
  <div class="listItem" @click="seeArticle">
    <div class="listWrap">
      <div class="left">
        ...
        <h4
          class="title"
          :class="itemInfo.article_info.cover_image ? '' : 'noImg'"
        >
        ...
        <div
          v-if="!noImg"
          class="desc"
          :class="(itemInfo.article_info.cover_image&&!noImg) ? '' : 'noImg'"
        >
        ...
        <div class="bottom">
          <div class="viewNum">
            ...
            <span>{{
              itemInfo.article_info.view_count / 10000 >= 1
                ? (itemInfo.article_info.view_count / 10000).toFixed(1) + "w"
                : itemInfo.article_info.view_count
            }}</span>
          </div>
          <div class="likeNum">
