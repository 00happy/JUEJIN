<template>
  <div class="home">
    <div class="listWrap">
      <div class="listHead">
        <span :class="sortType == 200 ? 'active' : ''" @click="selectType(200)"
          >推荐</span
        >
        <el-divider direction="vertical"></el-divider>
        <span @click="selectType(300)" :class="sortType == 300 ? 'active' : ''"
          >最新</span
        >
        <el-divider direction="vertical"></el-divider>
        <span
          @click="selectType(3)"
          :class="sortType != 200 && sortType != 300 ? 'active' : ''"
          >热榜</span
        >
        <el-select
          v-model="value"
          ...
          @change="selectType"
          v-show="sortType != 200 && sortType != 300"
          name="selcetInputName"
        >
          <el-option
    ...
    <aside>
      ...
      <div class="writeRank">
        ...
        <div class="author">
          <img
            src="https://p9-passport.byteacctimg.com/img/user-avatar/be943b52b5091019bf92eeec817413c9~300x300.image"
            alt=""
          />
          <div class="right">
            <div class="name">
              清秋
              <img
                src="https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/e108c685147dfe1fb03d4a37257fb417.svg"
                alt=""
              />
            </div>
...
export default {
  ...
  data() {
    return {
      adList: [
        "https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7d17b46ae3a64f7799ea474d0c5762c3~tplv-k3u1fbpfcp-no-mark:480:400:0:0.awebp?",
        "https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7d17b46ae3a64f7799ea474d0c5762c3~tplv-k3u1fbpfcp-no-mark:480:400:0:0.awebp?",
      ],
      articleList: [],
      cate_id: "",
